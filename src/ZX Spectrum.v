...
assign EXT_ADDRESS_BUS = CPU_ADDRESS_BUS[15:8];
...
ZX_Spectrum_MEM mem(
	...
	.CPU_ADDRESS(	CPU_ADDRESS_BUS),				// CPU memory access - port B
...
ZX_Spectrum_ULA #(
	...
	.CLK_28(		CLK_28),					// Clocks out from ULA
	.CLK_14(		CLK_14),
	.CLK_7(		 	CLK_7),
	...
	.CPU_DATA_BUS(	CPU_DATA_BUS),				// CPU IO access
...
// SD Card
 ...
 ZX_Spectrum_SD #(
	...
	.CLK_28(		CLK_28),
 	...
 	.CPU_DATA_BUS(	CPU_DATA_BUS),				// CPU Bus
 	.CPU_ADDRESS(	CPU_ADDRESS_BUS),
 	.CPU_IORQ(		CPU_IORQ),
 	.CPU_RD(		CPU_RD),
 	.CPU_WR(		CPU_WR),
