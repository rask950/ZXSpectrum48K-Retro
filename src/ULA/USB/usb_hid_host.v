...
module USB_HID_HOST (
	...
	output reg		[ 7: 0] KEY_MOD,								// Keyboard
	output reg		[ 7: 0] KEY_1,
	output reg		[ 7: 0] KEY_2,
	output reg		[ 7: 0] KEY_3,
	output reg		[ 7: 0] KEY_4,

	output reg		[ 7: 0] MOUSE_BTN,								// Mouse {5'bx, middle, right, left}
	...
	output reg				GAME_LEFT,								// Gamepad directional buttons
	output reg				GAME_RIGHT,
	output reg				GAME_UP,
	output reg				GAME_DOWN,
	output reg				GAME_A,									// Gamepad action buttons
	output reg				GAME_B,
	output reg				GAME_X,
	output reg				GAME_Y,
	output reg				GAME_SEL,
	...
	output			[63: 0]	DBG_HID_REPORT							// Debug - last HID report
);
