...
ukp ukp(
	...
	.UKP_READY(	DATA_READY),
	.UKP_STROBE(DATA_STROBE),
	.UKP_DATA(	UK_PAT),
	...
	reg					DATA_STROBE_R;
	reg					DATA_READY_R;					// delayed data_strobe and data_rdy
	...
	always @(posedge USB_CLK) begin : process_in_data
		...
		if(~DATA_READY && DATA_READY_R && DEV_TYPE != 0)	// falling edge of ukp data ready
			report <= 1;
	end
